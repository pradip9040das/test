...
- Choose a normalization such that $\textbf{w}^T\textbf{x}_{+} + b = 1 \quad \text{and} \quad \textbf{w}^T\textbf{x}_{-} + b = -1$ for the positive and negitive support vectors respectively.
